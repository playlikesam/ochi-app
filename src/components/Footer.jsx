...
function Footer() {
    return (
        <div className='flex gap-5 w-full h-screen bg-zinc-900 py-20 px-20  font-["Poppins"]'>
            <div className='w-1/2 h-full flex flex-col justify-between w-1/2'>
                <div className="headings">
                    <h1 className='text-[5vw] uppercase leading-none font-semibold -mb-2'>Eye-</h1>
                    <h1 className='text-[5vw] uppercase leading-none font-semibold -mb-2'>Opening</h1>
                </div>
            ...
            <div className='w-1/2'>
                <h1 className='text-[5vw] uppercase leading-none font-semibold -mb-2'>Presentations</h1>
